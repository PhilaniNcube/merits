...
const ProfileHeader = ({ schoolTeacher, school }) => {
  return (
      ...
      <div className="flex flex-col space-y-4">
        <div>
          <h2 className="text-2xl font-semibold">
            {`${schoolTeacher.firstName} ${schoolTeacher.lastName}`}{' '}
          </h2>
          <span className="text-sm dark:text-coolGray-400">{school.name}</span>
        </div>
