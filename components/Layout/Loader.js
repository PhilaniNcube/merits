...
const Loader = () => {
  return (
    <div>
      <h1 className="text-4xl text-center font-bold my-10">Please Log In</h1>
      <div className="py-4 my-10 mx-auto rounded shadow-md w-60 sm:w-80 animate-pulse bg-gray-900">
