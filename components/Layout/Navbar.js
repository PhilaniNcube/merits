...
export default function Navbar() {
  ...
  return (
    <Fragment>
      <div className="bg-gray-200 h-full w-full z-30">
        {/* Code block starts */}
              ...
              <div className="flex">
                ...
                <div className="hidden xl:flex items-center">
                  <div className="relative md:mr-6 my-2">
                    {user ? (
                      <button
                        className="focus:outline-none bg-red-100 border-red-100 font-medium border transition duration-150 ease-in-out hover:bg-red-300 hover:border-red-300 rounded text-gray-600 px-5 py-2 text-xs"
                        onClick={() => logout()}
                      >
                        Logout
                      </button>
